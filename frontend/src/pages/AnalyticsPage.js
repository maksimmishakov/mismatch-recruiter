        ...
        {loading ? (<div className="text-center py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {metrics.map((metric, idx) => {
                ...
                return (<div key={idx} className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-3">
                  {[{ label: '90-100%', percentage: 35 }, { label: '80-89%', percentage: 40 }, { label: '70-79%', percentage: 20 }, { label: '<70%', percentage: 5 }].map((item, idx) => (<div key={idx}>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-3">
                  {['Python', 'JavaScript', 'React', 'AWS', 'Docker', 'Kubernetes'].map((skill, idx) => (<div key={idx} className="flex items-center justify-between">
