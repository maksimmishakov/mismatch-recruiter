...
import { Settings, Users, Trash2, Database } from 'lucide-react';
const AdminPage = () => {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg">
          ...
          <div className="border-b border-gray-200 flex">
            ...
            return (<button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`flex items-center gap-2 px-6 py-4 font-medium transition ${activeTab === tab.id
          ...
          <div className="p-6">
            {activeTab === 'users' && (<div>
                ...
                {loading ? (<div className="text-center py-8">Loading users...</div>) : (<div className="overflow-x-auto">
            ...
            {activeTab === 'config' && (<div>
                ...
                <div className="space-y-4">
                  <div className="p-4 border border-gray-200 rounded-lg">
                    ...
                    <input type="password" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500" placeholder="••••••••••••••••"/>
                  </div>
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <label className="block text-sm font-medium text-gray-900 mb-2">
                      Max Upload Size (MB)
                    </label>
                    <input type="number" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500" defaultValue="5"/>
                  </div>
