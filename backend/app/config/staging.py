...
class StagingConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv(
        ...
        'postgresql://staging:staging@staging-db.internal:5432/mismatch_staging'
    )
    ...
    # CORS
    CORS_ORIGINS = ['https://staging.mismatch-recruiter.ru', 'https://app-staging.mismatch-recruiter.ru']
    ...
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_DEFAULT_SENDER_STAGING', 'noreply@staging.mismatch-recruiter.ru')
